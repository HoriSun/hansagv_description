## repository_name (indigo) - 0.0.1-1

The packages in the `repository_name` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo repository_name --edit` on `Wed, 06 Jul 2016 09:39:59 -0000`
...
## repository_name (indigo) - 0.0.1-0
